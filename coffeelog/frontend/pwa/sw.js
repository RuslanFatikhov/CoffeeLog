...
const APP_SHELL = [
  ...
  `/static/js/i18n.js${VERSION_QUERY}`,
  `/static/js/idb.js${VERSION_QUERY}`,
  `/static/data/taste_tags.en.json${VERSION_QUERY}`,
  `/static/data/taste_tags.ru.json${VERSION_QUERY}`,
  `/static/data/countries.en.json${VERSION_QUERY}`,
  `/static/data/countries.ru.json${VERSION_QUERY}`,
  `/static/data/wheel.realdata.v1.en.json${VERSION_QUERY}`,
  `/static/data/wheel.realdata.v1.ru.json${VERSION_QUERY}`,
